...
from backend.algorithm.season_evaluator import find_winners, get_top_3_ranking
...
class TestSeasonEvaluation(unittest.TestCase):
    ...
    def test_find_winners_returns_all_players_with_max_goals(self):
        results = find_winners(self.players, 'goals', 'max')
    ...
    def test_find_winners_calculates_avg(self):
        ...
        results = find_winners(sample_df, 'goals', method='max')
